...
export class TourAuthoringService {
  ...
  getAuthorTours(authorId : number) : Observable<Tour[]>{
    return this.http.get<Tour[]>("http://localhost:8090/tour/authortours/"+authorId,);
  }
  ...
  updateTour(tour: Tour): Observable<Tour> {
    ...
    return this.http.post<Tour>("http://localhost:8090/tour", tour)
  }
  ...
  getTourById(id: number): Observable<Tour> {
    return this.http.get<Tour>("http://localhost:8090/tour/" + id)
  }
  ...
  publishTour(tourId: number): Observable<Tour> {
    return this.http.put<Tour>(
      "http://localhost:8090/tour/publish",
      tourId
    );
  }
  ...
  archiveTour(tourId: number): Observable<Tour> {
    return this.http.put<Tour>(
      "http://localhost:8090/tour/archive",
      tourId
    );
  }
